...
func main() {
	...
	for s.Scan() {
		txt := s.Text()
		matrix = append(matrix, txt)
	}

	solution(matrix)
}

func solution(matrix []string) {
	...
	foundSymbol := false
	checkAndReset := func() {
		if numAsStr != "" && foundSymbol {
			number, err := strconv.Atoi(numAsStr)
			if err != nil {
				panic(err)
			}
			sum += number
	...
	for rowIdx, row := range matrix {
		for columnIdx, item := range row {
			// if we're looking at a number...
			if unicode.IsNumber(item) {
				// start building the number
				numAsStr += string(item)
				// if we've yet to find a symbol...
				if !foundSymbol {
					// check all around this number for a symbol.
					for _, offset := range offsets {
						r := rowIdx + offset[0]
						c := columnIdx + offset[1]
						// ensure we're checking within bounds...
						if r < 0 || r > height-1 || c < 0 || c > length-1 {
							continue
						}
						// check that the element is a symbol.
						element := matrix[r][c]
						if isSymbol(rune(element)) {
							foundSymbol = true
						}
					}
				}
			} else { // if the thing we're not looking at is a number, check if we've built a string and have found a symbol.
				checkAndReset()
			}
		}
	}
...
var input = `.479........155..............944.....622..............31.........264.......................532..........................254.........528.....
..............-...............%.....+...................=....111*.................495.......+.......558..................../..........*.....
